...
.controller('tagmanagementCtrl', function (user, $timeout) {
    ...
    */
    ...
    app.addtag = function (tagData) {
        app.successMsg = false;
        app.errorMsg = false;

        user.addtag(app.tagData).then(function (data) {
            if(data.data.success) {
                app.successMsg = data.data.message;
                gettag();
                $timeout(function () {
    ...
    app.deletetag = function (tag) {
        app.errorMsg = false;
        user.deletetag(tag).then(function (data) {
            if(data.data.success) {
                gettag();
            } else {
                app.errorMsg = data.data.message;
